...
function Shoes() {
  ...
  const btnHandle = (id) => {
    console.log('sub', id)
    console.log(productItems.map((id,name)=>(
      <h2>{name}</h2>
    )))
    {
        ...
        <div className='Category1'>
          {productItems.map((productItems) => (
            <div className='itemsCart' key={productItems.id}>
              ...
              {inc1 > 0 && productItems.id === 1 && <p>{inc1}</p>}
              {inc2 > 0 && productItems.id === 2 && <p>{inc2}</p>}
              {inc3 > 0 && productItems.id === 3 && <p>{inc3}</p>}
              {inc4 > 0 && productItems.id === 4 && <p>{inc4}</p>}
        ...
        {showForm ? <div className="form-popups" id="myForm">
          <div classNme="form-container">
            ...
            <div className="titles">
              ...
              {inc1 ? <p className="title1">nike1: $125 x {inc1} = ${inc1 * 125}</p> : null}
              {inc2 ? <p className="title2">nike2: $125 x {inc2} = ${inc2 * 125}</p> : null}
              {inc3 ? <p className="title3">nike3: $125 x {inc3} = ${inc3 * 125}</p> : null}
              {inc4 ? <p className="title4">nike4: $125 x {inc4} = ${inc4 * 125}</p> : null}
            </div>
